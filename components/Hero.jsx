...
const Hero = () => {
    return (
      <div className="px-4 flex flex-col my-8 mx-8 border-2 border-slate-300 py-6 rounded-2xl lg:px-40 md:flex-row">
          <div className="flex flex-col space-y-4 justify-end flex-1 h-18">
              <h1 className="text-2xl sm:text-4xl px-10 -mx-10 font-bold">
              Olá criadores de conteúdo! Aqui você recebe em primeira mão as melhores novidades e estratégias personalizadas.
              </h1>
              <p className="mt-2 mb-1 underline decoration-4 decoration-[#f7ab0a] h-32">
