    ...
    return (
      <div className="px-4 flex flex-col my-8 mx-8 bg-[#2f343f] border-2 border-slate-300 py-6 rounded-2xl lg:px-40 md:flex-row">
          <div className="flex flex-col space-y-2 justify-end flex-1 h-18">
              ...
              "Veja em primeira mão as melhores novidades e estratégias personalizadas. Não fique para trás, assine nossa Newsletter!”
              </h1>
              ...
              <Link 
                  href="/Blog"
                  className="my-5 -mx-4.5 w-60 h-8 px-4 py-8 bg-yellow-400 flex items-center text-sm font-semibold text-[#2f343f]  rounded"
              >
